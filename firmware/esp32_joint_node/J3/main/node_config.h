...
// Motor Driver
    ...
    // Comment out if not
    #define ILIM_CONNECTED //J3 has ILIM
...
// Encoder
    ...
    #define GEAR_REDUCTION (1000.0F*1.01250F) // Motor gearbox
...
// Controller
    ...
    #define CONTROLLER_GAIN_KI 15.5F //5.5F
...
// TWAI
    ...
    // TWAI Address
        //J3
        #define DEVICE_ID               0x003
        #define ID_STATE_REQUEST        0x0A3
        #define ID_STATE_BROADCAST_REQUEST 0x0A6

        #define ID_STATE_RESPONSE       0x0B3
        
        #define ID_SETPOINT_CHANGE      0x0C3
