...
// Motor Driver
    // Driver IN pins
    #define DRV_IN1 GPIO_NUM_25
    #define DRV_IN2 GPIO_NUM_26
    

    // If the ILIM pin of the driver is connected or not
    // Comment out if not
    //#define ILIM_CONNECTED //J4 has no ILIM

    // Measured value of ILIM Resistor
    //#define ILIM_RESISTOR 46.37F //kOhm
...
// Encoder
    ...
    #define GEAR_REDUCTION 131.0F
    
    // Flip encoder
    //#define ENCODER_FLIP

    #define VELOCITY_FILTER_CONSTANT 0.25F
    #define FILTER_FREQUENCY 1000
    
// Controller
    #define CONTROLLER_FREQUENCY 500
    #define CONTROLLER_GAIN_KP 200.0F //100.0F
    #define CONTROLLER_GAIN_KI 15.0F //2.5F
    #define CONTROLLER_INTEGRATOR_LIMIT 80.0F
    #define CONTROLLER_GAIN_KD 0.0F
    #define CONTROLLER_MAX_VELOCITY (5.0F*M_PI)

// Trajectory controller
    #define TRAJ_CONTROLLER_GAIN 10.0F
...
// TWAI
    ...
    // TWAI Address
        ...
        #define ID_STATE_REQUEST        0x0A4
        #define ID_STATE_BROADCAST_REQUEST 0x0A6

        #define ID_STATE_RESPONSE       0x0B4
        
        #define ID_SETPOINT_CHANGE      0x0C4
