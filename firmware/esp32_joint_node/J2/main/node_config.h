...
// Motor Driver
    // Driver IN pins
    #define DRV_IN1 GPIO_NUM_5
    #define DRV_IN2 GPIO_NUM_17
    

    // If the ILIM pin of the driver is connected or not
    // Comment out if not
    #define ILIM_CONNECTED //J2 has ILIM

    // Measured value of ILIM Resistor
    #define ILIM_RESISTOR 19.96F //kOhm 
...
// Encoder
    ...
    #define GEAR_REDUCTION (19.0F*50.0F) // Motor gearbox
...
// TWAI
    ...
    // TWAI Address
        //J3
        #define DEVICE_ID               0x002
        #define ID_STATE_REQUEST        0x0A2
        #define ID_STATE_BROADCAST_REQUEST 0x0A6

        #define ID_STATE_RESPONSE       0x0B2
        
        #define ID_SETPOINT_CHANGE      0x0C2
